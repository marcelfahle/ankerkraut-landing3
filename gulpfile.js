...
gulp.task("html", ["styles", "scripts"], () => {
  return (
    gulp
      ...
      //d1aua0slsiq8z8.cloudfront.net
      .pipe(
        cdnizer({
          defaultCDNBase: "//d1aua0slsiq8z8.cloudfront.net/lp/",
          allowRev: false,
          allowMin: false,
          files: [
            ...
            "scripts/vendor.js",
            {
              ...
              cdn:
                "//d1aua0slsiq8z8.cloudfront.net/skin/frontend/ultimo/default/${ filename }"
            },
            "**/*.{gif,png,jpg,jpeg}",
            {
              file: "favicon.ico",
              cdn:
                "//d1aua0slsiq8z8.cloudfront.net/media/favicon/default/${ filename }"
            }
          ]
        })
      )
